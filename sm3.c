...
static void sm3_process( SM3_CTX *ctx, const void *data )
{
...
// 		W1[j] = 0;
    ...
    p = data;//
    GET_ULONG_BE( W[ 0], p,  0 );
    GET_ULONG_BE( W[ 1], p,  4 );
    GET_ULONG_BE( W[ 2], p,  8 );
    GET_ULONG_BE( W[ 3], p, 12 );
    GET_ULONG_BE( W[ 4], p, 16 );
    GET_ULONG_BE( W[ 5], p, 20 );
    GET_ULONG_BE( W[ 6], p, 24 );
    GET_ULONG_BE( W[ 7], p, 28 );
    GET_ULONG_BE( W[ 8], p, 32 );
    GET_ULONG_BE( W[ 9], p, 36 );
    GET_ULONG_BE( W[10], p, 40 );
    GET_ULONG_BE( W[11], p, 44 );
    GET_ULONG_BE( W[12], p, 48 );
    GET_ULONG_BE( W[13], p, 52 );
    GET_ULONG_BE( W[14], p, 56 );
    GET_ULONG_BE( W[15], p, 60 );
 ...
 * SM3 process buffer
 */
void sm3_update( SM3_CTX *ctx, const void *input, unsigned int ilen )
{
    int fill;
    unsigned long left;
 ...
 * SM3 final digest
 */
void sm3_finish( unsigned char *output, SM3_CTX *ctx )
{
 ...
 */
void sm3_256( unsigned char *input, unsigned int ilen,
