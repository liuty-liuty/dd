...
static int parse_parm_set( int *levels, param_set_t *lm_array,
    ...
    if (check_string( &parm_set, "SHAKE192," )) {
        hash_type = 3;
    } else if (check_string( &parm_set, "SHAKE256," )) {
        hash_type = 2;
    } else if (check_string( &parm_set, "SHA192," )) {
        hash_type = 1;
    } else {
    ...
    for (i=0;; i++) {
        ...
        if (*parm_set == '/') {
            ...
            case 4: ots = pick( hash_type, LMOTS_SHA256_N32_W4,
                                           ...
                                           LMOTS_SHAKE_N24_W4 );
                    break;
            case 8: /* We're fine with the default ots */
                    break;
...
static const char *hash_name(int hash_type) {
    ...
    case 2: return "SHAKE/256";
    case 3: return "SHAKE/192";
    default: return "???";
    }
}
...
static void list_parameter_set(int levels, const param_set_t *lm_array,
    ...
    for (i=0; i<levels; i++) {
        ...
        case LMS_SHAKE_N32_H5:  h = 5;  hash = 2; break;
        case LMS_SHAKE_N32_H10: h = 10; hash = 2; break;
        case LMS_SHAKE_N32_H15: h = 15; hash = 2; break;
        case LMS_SHAKE_N32_H20: h = 20; hash = 2; break;
        case LMS_SHAKE_N32_H25: h = 25; hash = 2; break;
        case LMS_SHAKE_N24_H5:  h = 5;  hash = 3; break;
        case LMS_SHAKE_N24_H10: h = 10; hash = 3; break;
        case LMS_SHAKE_N24_H15: h = 15; hash = 3; break;
        case LMS_SHAKE_N24_H20: h = 20; hash = 3; break;
        case LMS_SHAKE_N24_H25: h = 25; hash = 3; break;
        }
        ...
        case LMOTS_SHAKE_N32_W1: w = 1; hash2 = 2; break;
        case LMOTS_SHAKE_N32_W2: w = 2; hash2 = 2; break;
        case LMOTS_SHAKE_N32_W4: w = 4; hash2 = 2; break;
        case LMOTS_SHAKE_N32_W8: w = 8; hash2 = 2; break;
        case LMOTS_SHAKE_N24_W1: w = 1; hash2 = 3; break;
        case LMOTS_SHAKE_N24_W2: w = 2; hash2 = 3; break;
        case LMOTS_SHAKE_N24_W4: w = 4; hash2 = 3; break;
        case LMOTS_SHAKE_N24_W8: w = 8; hash2 = 3; break;
        }
